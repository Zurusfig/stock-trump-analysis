...
def render_risk(results: list[StrategyResult], ticker: str) -> None:
    ...
    st.plotly_chart(fig_scatter, use_container_width=True, config={"responsive": True, "displayModeBar": False, "scrollZoom": False})

    vcol, sscol = st.columns(2)
    ...
    with vcol:
        ...
        st.plotly_chart(fig_vol, use_container_width=True, config={"responsive": True, "displayModeBar": False, "scrollZoom": False})
    ...
    with sscol:
        ...
        st.plotly_chart(fig_ss, use_container_width=True, config={"responsive": True, "displayModeBar": False, "scrollZoom": False})
    ...
    st.plotly_chart(fig_dd_bar, use_container_width=True, config={"responsive": True, "displayModeBar": False, "scrollZoom": False})
